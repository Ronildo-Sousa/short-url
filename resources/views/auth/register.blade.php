    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-inputs.text-input id="name" class="block w-full mt-1" type="text" name="name" :value="old('name')"
                    required autofocus />
            ...
            <div class="mt-4">
                ...
                <x-inputs.text-input id="password" class="block w-full mt-1" type="password" name="password" required
            ...
            <div class="mt-4">
                ...
                <x-inputs.text-input id="password_confirmation" class="block w-full mt-1" type="password"
